...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.log("📝 Update profile request:", { ...body, profileImage: body.profileImage ? "***" : "" })
    ...
    try {
      ...
      if (!response.ok) {
        console.error("❌ Real API update profile error:", data)
    ...
    console.error("💥 Update profile proxy error:", error.message)
